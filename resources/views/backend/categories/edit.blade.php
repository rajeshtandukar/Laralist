            ...
            <div class="box-body">
               ...
               @if($errors->has())
                ...
                @endif  
                 ...
                 {!! Form::open(['route' => 'admin.categories.update','files' => true , 'class' =>'form-horizontal']) !!}
                  ...
                  <div class="box-body">
                    <div class="form-group">
                     {!! Form::label('title', 'Title', array('class'=> 'col-sm-2 control-label')) !!}
                      <div class="col-sm-10">
                       {!! Form::text('title', $category->title, ['class'=>'form-control', 'placeholder'=>'Enter Title', 'id'=>'title']) !!}
                      </div>
                    </div>
                    ...
                    <div class="form-group">              
                      ...
                      <div class="col-sm-10">
                       {!! Form::text('alias', $category->alias, ['class'=>'form-control', 'placeholder'=>'Enter Alias', 'id'=>'alias']) !!}
                      </div>
                    </div> 
                     ...
                     {!! Form::label('published', 'Published', array('class'=> 'col-sm-2 control-label')) !!}
                      <div class="col-sm-10">
                        <input type="radio" name="published" class="minimal"  value="1" @if($category->published ==1) {{ 'checked' }} @endif > Yes 
                        <input type="radio" name="published" class="minimal" value="0" @if($category->published ==0) {{ 'checked' }} @endif> No
                      </div>
                    </div>
